...
\headedsection  % sets the header for the section and includes any subsections
  ...
  \headedsubsection
    ...
    {Apr \apo19 -- Present}
    {\bodytext{
      Hiring manager and team lead responsible for technical design and implementation of the AMP Recover platform, consisting of a provider-facing web app and mobile apps used by orthopedic rehabilitation patients and their care teams.

      \vspace{0.5em}
      \textit{Environment:} Small healthtech startup with the mission to facilitate world-class orthopedic rehabilitation outcomes through individually tailored recovery protocols and deep patient engagement. Technologies include Ruby on Rails, Angular, the Ionic Framework, Capacitor, Cordova, iOS, Android, Amazon Web Services, and Chef.
    }}
}
...
\headedsection  % sets the header for the section and includes any subsections
  {\href{http://rented.com}{Rented.com}}
  {\textsc{Atlanta, GA}} {%
  \headedsubsection
...
\headedsubsection
  ...
  % Information Gain Analysis, Linear Regression, Logistic Regression, Holtz-Winters Time Series Forecasting, etc.}
    ...
    % \textit{Machine Learning and Statistics:} Random Forests (Decision Forests), k-NN, SVM, Decision Trees, K-Means, K-Medoids, DBScan, Hierarchical Clustering, Self Organizing Maps, Neural Networks, Principle Components Analysis (PCA), Supervised Machine Learning (Classification, Regression), Unsupervised Machine Learning (Clustering), Graph Analytics, Natural Language Processing (NLP), Information Gain Analysis, Linear Regression, Logistic Regression, Holtz-Winters Time Series Forecasting, Data Visualization, Statistical Hypothesis Testing, Statistical Distributions
...
\headedsubsection
  ...
  {\bodytext{
    ...
    \vspace{0.25em}
    \textit{Ruby:} Ruby on Rails, Devise, Sidekiq, Carrierwave, Searchkick

    \vspace{0.25em}
    \textit{JavaScript:} Angular, d3.js, jQuery

    \vspace{0.25em}
    \textit{Mobile:} Ionic Framework, iOS, Android
...
\headedsubsection
  ...
  {\bodytext{
    ...
    \vspace{0.25em}
    \textit{Cloud Technologies:} Amazon AWS, s3, ec2, Redshift, DynamoDB, Hadoop, HDFS, Map Reduce, Spark, Storm, RabitMQ, Kafka
  }}
