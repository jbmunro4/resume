...
\headedsection  % sets the header for the section and includes any subsections
  ...
  \headedsubsection
    {Lead Data Scientist}
    {May \apo15 -- Mar 16}
    {\bodytext{Individual contributor with a wide range of responsibilities across product development, design, and research. I built the next iteration of Anomali's machine learning-based scoring engine, worked on targeted research projects with security analysts, and contributed to the sales team by integrating Anomali's many data sources to give a \(360^{\circ}\) view of customers as they move through the sales process and use Anomali's SaaS security platform.}}
}
